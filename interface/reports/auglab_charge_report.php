...
if (!empty($_POST['download_csv'])) {
    ...
    $filename = "alab_charge_report_export_{$timestamp}.csv";
...
?>
    ...
    <head>
        ...
        <title><?php echo xlt('Alab Charge Report') ?></title>
    ...
    <body class="body_top">
        ...
        <span class='title'><?php echo xlt('Report'); ?> - <?php echo xlt('Alab Charge Report'); ?></span>

        <form method='post' action='auglab_charge_report.php' enctype='multipart/form-data' id='theform' onsubmit='return top.restoreSession()'>
                            ...
                            <table>
                                ...
                                <tr>
                                    <td class='col-form-label'>
                                        <?php echo xlt('Service Date From'); ?>:
                                    </td>
                                    <td>
                                    ...
                                    <td class='col-form-label'>
                                        <?php echo xlt('Service Date To {{Range}}'); ?>:
                                    </td>
                                    <td>
